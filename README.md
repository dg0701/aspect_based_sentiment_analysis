...
#Objectives
Extract aspect terms from textual reviews
Determine sentiment polarity for each aspect
Compare traditional deep learning approaches with transformer-based models
Evaluate model performance using standard NLP evaluation metrics
...
2. Sentiment Analysis using SIA
